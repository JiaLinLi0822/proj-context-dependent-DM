...
var correctanswer=["2","4","1"];
var correctanswerdisplay=["3.5","3.3"];
		...
		if(questionnum<=2){
			if(correct_or_wrong===1){
				...
				if(questionnum===1){
					...
					$('#choice1').text('得到1.0到5.0之间的评分；其中评分在3分左右的可能性更大。');
					$('#choice2').text('得到1.0到5.0之间的评分；每一个得分都将是等可能的。');
					$('#choice3').text('只能得到评分在3.5分以下的评分。');
					$('#choice4').text('以上说法均不正确，我只能知道我能够得到1.0到5.0之间的评分。');
					$('#quiz2choice4').show();
				}
				else{
