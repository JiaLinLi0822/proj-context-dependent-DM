...
```{r}
data <- read.csv('/Users/lijialin/Desktop/课程/毕业设计/data/DrawFig/Cond3/sub28.csv')
...
```{r}
data <- read.csv("/Users/lijialin/Desktop/课程/毕业设计/data/drawFig/Cond3/sub32.csv")
...
res <- lm(daction ~ lasttrialreward + lastmaxreward + totaldays + maxreward + lastrewardcount, result)
summary(res)
